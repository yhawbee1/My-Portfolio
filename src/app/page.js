  ...
  return (
    <section className="mx-auto flex h-full w-[90%] items-center justify-center xl:w-[80%] min-[1537px]:w-[75%]">
      <span className="space-y-2 2xl:space-y-3 min-[1537px]:space-y-7">
        ...
        <h1 className="font-epilogue text-[39px] font-bold uppercase leading-[50px] max-[360px]:text-[32px] max-[360px]:leading-[40px] max-[320px]:text-[25px] max-[320px]:leading-[30px] md:text-[80px] md:leading-[80px] 2xl:text-[96px]  2xl:leading-[100px] min-[1537px]:text-[120px] min-[1537px]:leading-[110px] ">
        ...
        <div className="flex flex-col-reverse md:flex-row md:items-center md:justify-between md:gap-10">
          ...
          <p className=" mb-2 w-full font-poppins text-base max-[320px]:mb-1 max-[320px]:text-[14px] md:w-[65%] xl:w-[45%] 2xl:w-[50%] min-[1537px]:w-[45%]">
